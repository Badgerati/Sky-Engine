...
public class Rectangle extends Polygon
{
	 ...
	 * Create new instance of a geometric Rectangle
	 */
	public Rectangle(Vector2D position, Vector2D v1, Vector2D v2, Vector2D v3, Vector2D v4)
	{
	 ...
	 * Create new instance of a geometric Rectangle
	 */
	public Rectangle(Vector2D v1, Vector2D v2, Vector2D v3, Vector2D v4)
	{
	 ...
	 * Create new instance of a geometric Rectangle
	 */
	protected Rectangle(Vector2D position, float width, float height, Vector2D velocity, float mass)
	{
	 ...
	 * Create new instance of a geometric Rectangle
	 */
	protected Rectangle(Vector2D position, Vector2D v1, Vector2D v2, Vector2D v3, Vector2D v4, Vector2D velocity, float mass)
	{
	 ...
	 * Create new instance of a geometric Rectangle
	 */
	protected Rectangle(Vector2D v1, Vector2D v2, Vector2D v3, Vector2D v4, Vector2D velocity, float mass)
	{
	...
	{
		return new Rectangle(Position, vertices[0], vertices[1], vertices[2], vertices[3]);
	}
