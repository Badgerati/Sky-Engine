...
public class SlidingText extends CustomText
{
	 ...
	 */
	public SlidingText(String text, Vector2 position, int colour, float size, int length, float speed)
	{
	 ...
	 * Create new instance of sliding text
	 */
	public SlidingText(String text, Vector2 position, Paint paint, int length, float speed)
	{
